				...
				<div className="container-fluid mt-5">
				  <div className="card shadow">
				    ...
				    <div className="d-flex justify-content-around mt-3 my-2">
				      <button className="p-1  px-2 rounded brand-download-image-btn text-light brand-small-text-2 shadow-sm">
				      ...
				      <button type="button" className="p-1 px-2  rounded brand-small-text-2 text-capitalize text-dark brand-view-image-btn">view images</button>
				    </div>
				  </div>
				</div>
