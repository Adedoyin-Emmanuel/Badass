							...
							<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 225.000000 225.000000"
							 	preserveAspectRatio="xMidYMid meet"
			              		...
			              		height={"15px"}
			              		fill="#fff"
					            className={`footer-svgs footer-svg-convert text-center m-auto ${props.currentActiveElement}`}
					            viewBox="0 0 512 512"
				...
				<section className="remove-bg-nav" onClick={navigate.navigateToUpload}>
					<section className="d-flex align-items-center justify-content-center footer-icon py-2">
							 ...
							 <svg
				              ...
				              height={"15px"}
				              fill="#fff"
					          className={`footer-svgs text-center m-auto ${props.currentActiveElement}`}			              viewBox="0 0 512 512"
				...
				<section className="search-nav" onClick={navigate.navigateToDownload}>
					...
					<section className="d-flex align-items-center justify-content-center footer-icon py-2">
						 <svg
			              ...
			              height={"15px"}
			              fill="#fff"
				          className={`footer-svgs text-center m-auto ${props.currentActiveElement}`}
			              viewBox="0 0 512 512"
