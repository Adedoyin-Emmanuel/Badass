...
const BackToTop = ():JSX.Element=>{
	...
	return (
		<React.Fragment>
			<section className="arrow-up back-to-top d-flex justify-content-center align-items-center brand-primary-color" onClick={scrollToTop}>
				  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-arrow-up text-white fw-bold" viewBox="0 0 16 16">
